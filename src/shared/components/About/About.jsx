  ...
  return (
    <>
      <div className="container py-14 ">
        <div className="mx-auto my-10 w-[120px] border-b-[3px] border-[#0fb9b1] text-2xl font-semibold md:w-[150px] md:text-3xl">
        ...
        <div className="flex flex-wrap items-center justify-center gap-10 xl:justify-between">
          <div>
            <img
              className="h-[280px] w-[280px] object-cover ring-[3px] ring-[#0fb9b1] md:h-[400px]  md:w-[400px]"
              src={my_img}
              alt="my_img"
            />
          </div>
